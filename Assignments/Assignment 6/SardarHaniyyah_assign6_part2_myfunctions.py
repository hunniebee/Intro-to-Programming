...
def print_number(number, width, character):
    if number == 0:
        return print(number_0(width, character))
    elif number == 1:
        return print(number_1(width, character))
    elif number ==2:
        return print(number_2(width, character))
    elif number == 3:
        return print(number_3(width, character))
    elif number == 4:
        return print(number_4(width, character))
    elif number == 5:
        return print(number_5(width, character))
    elif number == 6:
        return print(number_6(width, character))
    elif number == 7:
        return print(number_7(width, character))
    elif number ==8:
        return print(number_8(width, character))
    elif number == 9:
        return print(number_9(width, character))
